...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
    ...
    return (
      <div className="min-h-screen bg-white w-full max-w-md mx-auto flex flex-col px-8 py-10 animate-in fade-in slide-in-from-bottom duration-500 overflow-y-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-500 text-sm">Welcome to Oviss Salon. Let's complete your profile.</p>
        </div>
  ...
  return (
    <div className="min-h-screen bg-white w-full max-w-md mx-auto flex flex-col px-8 py-16">
      <div className="mb-12 text-center">
        <div className="w-20 h-20 bg-black rounded-[2.5rem] flex items-center justify-center mx-auto mb-6 shadow-2xl rotate-6">
      ...
      {step === 'input' ? (
        ...
        <div className="space-y-8 w-full text-center animate-in fade-in slide-in-from-right duration-300">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">Sent to <span className="text-black font-bold">{identifier}</span></p>
          </div>
